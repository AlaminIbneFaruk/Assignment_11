  ...
  return (
    <div className="navbar sticky top-0 z-50 bg-base-100 shadow-md">
      ...
      <div className="navbar-start">
        ...
        <Link
          to="/"
          className="btn btn-ghost text-base md:text-2xl lg:text-3xl font-sans font-bold"
        >
          <img
          ...
          />
          <span className="relative bg-gradient-to-r from-stone-600 to-amber-300 bg-clip-text text-transparent">
            Artifact Bazaar
          </span>
        </Link>
      </div>
          ...
          <div className="flex items-center gap-2">
            <div className="dropdown dropdown-end">
              ...
              >
                {user?.photoURL && (
                  ...
                  >
                    ...
                    />
                    {isHovered && (
                      <div className="inline">{user?.displayName}</div>
                    )}
                  </div>
                )}
              </button>
              ...
              >
                ...
                <li>
                  <Link to={`/liked-artifacts/${user?.uid}`}>
                    Liked Artifacts
                  </Link>
                </li>
              </ul>
