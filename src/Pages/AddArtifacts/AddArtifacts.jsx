...
const AddArtifact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error("These are given", artifactDetails);
            ...
            <div className="text-center lg:text-left mx-5 mt-5">
              <h1
                className="font-serif font-extrabold text-3xl md:text-4xl
                  bg-gradient-to-r from-stone-600 to-amber-300 bg-clip-text text-transparent py-4 uppercase tracking-wider mx-auto text-center"
              >
                Add Artifact
              </h1>
              <p className="pt-6 text-neutralText text-lg font-bold">
            ...
            <form className="card-body" onSubmit={handleSubmit}>
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Artifact Image</span>
                </label>
                <input
                  type="text"
                  name="artifactImage"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Artifact Name</span>
                </label>
                <input
                  type="text"
                  name="artifactName"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Created At</span>
                </label>
                <input
                  type="text"
                  name="createdAt"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Artifact Type</span>
                </label>
                <select
                  name="artifactType"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Historical Context:</span>
                </label>
                <textarea
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Discovered At:</span>
                </label>
                <input
                  type="text"
                  name="discoveredAt"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Discovered By:</span>
                </label>
                <input
                  type="text"
                  name="discoveredBy"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Present Location:</span>
                </label>
                <input
                  type="text"
              ...
              <div className="form-control">
                <label className="label">
                  <span className="label-text text-xl font-bold">Added By:</span>
                </label>
                <input
                  type="text"
